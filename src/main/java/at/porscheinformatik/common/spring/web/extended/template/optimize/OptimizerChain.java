...
public class OptimizerChain
{
	...
	public String optimize(ResourceType type, String uri, String input)
			throws IOException
	{
	...
	{
		processors = new HashMap<ResourceType, List<ResourcePreProcessor>>();

		for (ResourceType type : ResourceType.values())
		{
			List<ResourcePreProcessor> typeProcessors = config
					.getProcessors(type);
	...
	private ro.isdc.wro.model.resource.ResourceType findWroType(
			ResourceType type)
	{
		switch (type)
		{
