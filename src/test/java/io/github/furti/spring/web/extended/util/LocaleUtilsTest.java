...
public class LocaleUtilsTest
{
    ...
    public void closestSupportedLocale(Locale locale, List<Locale> supportedLocales, Locale expected)
    {
        Locale actual = LocaleUtils.closestSupportedLocale(supportedLocales, locale);

        assertThat(actual, equalTo(expected));
    }

    @Test(dataProvider = "stringData")
    public void closestSupportedLocaleString(String languageTag, List<Locale> supportedLocales, Locale expected)
    {
        Locale actual = LocaleUtils.closestSupportedLocale(supportedLocales, languageTag);
