...
public class ExpressionHandlerConfig
{
	...
	{
		return new StyleExpressionHandler(configurerConfig.getStyleConfig(),
				configurerConfig.appConfig());
	}

	@Bean
	public ScriptExpressionHandler scriptExpressionHandler()
	{
		return new ScriptExpressionHandler(configurerConfig.getScriptConfig(),
				configurerConfig.appConfig());
	}
	...
	{
		return new CdnExpressionHandler(configurerConfig.appConfig(),
				configurerConfig.getCdnConfig());
	}
