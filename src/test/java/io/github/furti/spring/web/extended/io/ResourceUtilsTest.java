...
public class ResourceUtilsTest
{
    ...
    public void buildLocalizedTemplateNames()
    {
        ...
        assertThat(ResourceUtils.localizedResources("index", new Locale("de")),
            equalTo(Arrays.asList("index_de", "index")));
        assertThat(ResourceUtils.localizedResources("index.html", new Locale("de")),
            equalTo(Arrays.asList("index_de.html", "index.html")));
        assertThat(ResourceUtils.localizedResources("index", new Locale("de", "AT")),
    ...
    public void normalize()
    {
        ...
        assertThat(ResourceUtils.normalize("webjar:test/*/css/test.css", "../fonts/font.ff"),
