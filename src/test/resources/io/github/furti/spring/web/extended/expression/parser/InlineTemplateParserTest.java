...
public class InlineTemplateParserTest {
    ...
    public void inlineTemplate(String input, List<String> expected) {
        InlineTemplateParser parser = Parboiled.createParser(InlineTemplateParser.class);

        RecoveringParseRunner<String> runner = new RecoveringParseRunner<String>(parser.inlineTemplate());
    ...
    public Object[][] inlineTemplateData() {
        return new Object[][] {
            { "<p>DasisteinTest</p>", Arrays.asList("<p>DasisteinTest</p>") },
            { "<p>Das ist ein Test</p>", Arrays.asList("<p>Das ist ein Test</p>") },
            {
                "<p>Das ist ein Test</p>\n<p>mit mehreren Zeilen</p>",
                Arrays.asList("<p>Das ist ein Test</p>", " ", "<p>mit mehreren Zeilen</p>"),
            },
            {
