...
public class DefaultOptimizerConfig implements OptimizerConfig
{
	...
	private Map<ResourceType, Map<String, ResourcePreProcessor>> processors;
	private Map<ResourceType, List<String>> processorOrder;

	public DefaultOptimizerConfig()
	{
		processorOrder = new HashMap<ResourceType, List<String>>();
		processors = new HashMap<>();
	}

	@Override
	public void addOptimizer(ResourceType type, String name,
