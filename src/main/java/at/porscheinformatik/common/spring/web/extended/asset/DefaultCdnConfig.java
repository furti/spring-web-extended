...
{
	private Map<String, Map<String, CdnEntry>> stacks = new HashMap<String, Map<String, CdnEntry>>();

	@Override
	public CdnConfig addToStack(String stackName, String name, String location,
			String minifiedLocation)
	{
		...
		stacks.get(stackName).put(name,
				new CdnEntry(location, minifiedLocation));
